...
export default class Materials {
  ...
  mapTextures() {
    ...
    this.lightMatcapMaterial = new THREE.MeshMatcapMaterial({
      matcap: this.resources.items.lightMatcapTexture
    })
    this.neonBlueMatcapMaterial = new THREE.MeshMatcapMaterial({
      matcap: this.resources.items.neonBlueMatcapTexture
    })
    this.neonGreenMatcapMaterial = new THREE.MeshMatcapMaterial({
      matcap: this.resources.items.neonGreenMatcapTexture
    })
    ...
    this.arcadeScreenMaterial = this.getTransitionShaderMaterial(
      this.resources.items.arcadeScreenDefaultTexture
    )

    this.sideScreenMaterial = this.getSideScreenShaderMaterial(
    ...
    this.littleTVScreenVideoMaterial = this.getChromaKeyShaderMaterial(
      this.resources.items.littleTVScreenVideoTexture,
      new THREE.Color('rgb(0, 255, 0)')
    )
    this.tallScreenVideoMaterial = this.getChromaKeyShaderMaterial(
      this.resources.items.tallScreenVideoTexture,
      new THREE.Color('rgb(0, 255, 0)')
    )
    this.tvScreenVideoMaterial = this.getChromaKeyShaderMaterial(
      this.resources.items.tvScreenVideoTexture,
      new THREE.Color('rgb(0, 255, 0)')
    )

    this.smallScreen1Material = this.getTransitionShaderMaterial(
      this.resources.items.smallScreenOne1
    )
    this.smallScreen2Material = this.getTransitionShaderMaterial(
      this.resources.items.smallScreenTwo1
    )

    this.smallScreen3VideoMaterial = this.getChromaKeyShaderMaterial(
      this.resources.items.smallScreen3VideoTexture,
      new THREE.Color('rgb(0, 255, 0)')
    )
    this.smallScreen4VideoMaterial = this.getChromaKeyShaderMaterial(
      this.resources.items.smallScreen4VideoTexture,
      new THREE.Color('rgb(0, 255, 0)')
    )
    this.smallScreen5VideoMaterial = this.getChromaKeyShaderMaterial(
      this.resources.items.smallScreen5VideoTexture,
      new THREE.Color('rgb(0, 255, 0)')
    )
    ...
    this.bigScreenMaterial = new THREE.ShaderMaterial({
      ...
      uniforms: {
        ...
        uSpeed: { value: 0.3 },
        uLightColor: {
          value: new THREE.Color(this.debugObject.bigScreenLightColor)
        },
        uDarkColor: {
          value: new THREE.Color(this.debugObject.bigScreenDarkColor)
        },
        uDefaultTexture: {
          value: this.resources.items.bigScreenDefaultTexture
        },
      ...
      uniforms: {
        ...
        uLightColor: {
          value: new THREE.Color(
            this.debugObject.vendingMachineScreenLightColor
          )
        },
        uDarkColor: {
          value: new THREE.Color(this.debugObject.vendingMachineScreenDarkColor)
        },
        uDefaultTexture: {
          value: this.resources.items.vendingMachineDefaultTexture
        },
        uTexture1: { value: null },
        uTexture2: { value: null },
        uProgress: { value: 0 },
    ...
    if (this.debug.active) {
      ...
      this.debugFolder
        .add(this.hologramBaseMaterial.uniforms.uBigGridThickness, 'value')
        .min(0)
        .max(1)
        .step(0.001)
        .name('uBigGridThickness')
      this.debugFolder
        .add(this.hologramBaseMaterial.uniforms.uLittleGridThickness, 'value')
        .min(0)
        .max(1)
        .step(0.001)
        .name('uLittleGridThickness')
      this.debugFolder
        .add(this.hologramBaseMaterial.uniforms.uBigGridFrequency, 'value')
        .min(0)
        .max(10)
        .step(1)
        .name('uBigGridFrequency')
      this.debugFolder
        .add(this.hologramBaseMaterial.uniforms.uLittleGridFrequency, 'value')
        .min(0)
        .max(30)
        .step(1)
        .name('uLittleGridFrequency')
      this.debugFolder
        .add(this.hologramBaseMaterial.uniforms.uSpeed, 'value')
        .min(0)
        .max(3)
        .step(0.001)
        .name('uSpeed')
      ...
      //bigScreen
      this.debugFolder
        .add(this.bigScreenMaterial.uniforms.uXOffset, 'value')
        .min(-1)
        .max(1)
        .step(0.001)
        .name('bigScreenUXOffset')
      this.debugFolder
        .add(this.bigScreenMaterial.uniforms.uYOffset, 'value')
        .min(-1)
        .max(1)
        .step(0.001)
        .name('bigScreenUYOffset')
      this.debugFolder
        .add(this.bigScreenMaterial.uniforms.uRadialThickness, 'value')
        .min(0)
        .max(8.0)
        .step(0.001)
        .name('bigScreenURadialThickness')
      this.debugFolder
        .add(this.bigScreenMaterial.uniforms.uSpeed, 'value')
        .min(0)
        .max(4)
        .step(0.001)
        .name('bigScreenUSpeed')
      this.debugFolder
        .addColor(this.debugObject, 'bigScreenLightColor')
        .name('bigScreenLightColor')
        .onChange(() => {
          this.bigScreenMaterial.uniforms.uLightColor.value.set(
            this.debugObject.bigScreenLightColor
          )
        })
      this.debugFolder
        ...
        .onChange(() => {
          this.bigScreenMaterial.uniforms.uDarkColor.value.set(
            this.debugObject.bigScreenDarkColor
          )
        })

      //VendingMchineScreen
      this.debugFolder
        .add(this.vendingMachineScreenMaterial.uniforms.uXOffset, 'value')
        .min(-1)
        .max(1)
        .step(0.001)
        .name('vendingMachineScreenUXOffset')
      this.debugFolder
        .add(this.vendingMachineScreenMaterial.uniforms.uYOffset, 'value')
        .min(-1)
        .max(1)
        .step(0.001)
        .name('vendingMachineScreenUYOffset')
      this.debugFolder
        .add(
          this.vendingMachineScreenMaterial.uniforms.uRadialThickness,
          'value'
        )
        .min(0)
        .max(8.0)
        .step(0.001)
        .name('vendingMachineScreenURadialThickness')
      this.debugFolder
        .add(this.vendingMachineScreenMaterial.uniforms.uSpeed, 'value')
        .min(0)
        .max(4)
        .step(0.001)
        .name('vendingMachineScreenUSpeed')
      this.debugFolder
        .addColor(this.debugObject, 'vendingMachineScreenLightColor')
        .name('vendingMachineScreenLightColor')
        .onChange(() => {
          this.vendingMachineScreenMaterial.uniforms.uLightColor.value.set(
            this.debugObject.vendingMachineScreenLightColor
          )
        })
      this.debugFolder
        ...
        .onChange(() => {
          this.vendingMachineScreenMaterial.uniforms.uDarkColor.value.set(
            this.debugObject.vendingMachineScreenDarkColor
          )
        })
    }
  ...
  mapEasel() {
    if (this.config.touch === true) {
      this.easelMaterial = new THREE.MeshBasicMaterial({
        map: this.resources.items.easelTouchTexture
      })
    } else {
      this.easelMaterial = new THREE.MeshBasicMaterial({
        map: this.resources.items.easelClickTexture
      })
    }
